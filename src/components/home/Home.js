...
import Luffy from "../../img/luffy-happy.gif"
...
export default function Home({innerRef}) {
   ...
   return (
      <Box ref={innerRef} component={'main'} display={'flex'} flexDirection={{xs: 'column', md: 'row'}} alignItems={'center'}
         ...
         <Box>
            <h1>
            Hi, I'm <span style={{background: info.gradient, WebkitBackgroundClip: 'text', }}>{info.firstName}</span>
            <span className={Style.hand}>
               <img src={Luffy} alt="Luffy waving" style={{ width: '50px', height: '50px' }} />
            </span>
            </h1>
